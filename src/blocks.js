...
js['vector3']=function(a){
  ...
  return ['new Box3Vector3('+x+','+y+','+z+')',atomic];
}
...
js['rgbColor']=function(a){
  ...
  return ['new Box3RGBColor('+x+','+y+','+z+')',atomic];
}
...
js['rgbaColor']=function(a){
  ...
  return ['new Box3RGBAColor('+x+','+y+','+z+','+w+')',atomic];
}
...
js['Box3Entity']=function(b){
  return ['new Box3Entity()',atomic];
}
js['Box3World']=function(b){
  return ['new Box3World()',atomic];
}
js['Box3Voxels']=function(b){
  return ['new Box3Voxels()',atomic];
}
js['Box3Player']=function(b){
  return ['new Box3Player()',atomic];
}
